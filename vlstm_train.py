    ...
    for epoch in range(args.num_epochs):
        ...
        for batch in range(dataloader.num_batches):
            ...
            for sequence in range(dataloader.batch_size):
                ...
                # Forward prop
                outputs, _, _ = net(x_seq, hidden_states, cell_states, PedsList_seq, numPedsList_seq, dataloader,
                                    lookup_seq)
        ...
        if dataloader.valid_num_batches > 0:
            ...
            for batch in range(dataloader.valid_num_batches):
                ...
                for sequence in range(dataloader.batch_size):
                    ...
                    # Forward prop
                    outputs, _, _ = net(x_seq[:-1], hidden_states, cell_states, PedsList_seq[:-1], numPedsList_seq,
